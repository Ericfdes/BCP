...
//   );
// }
  const wordGradient = "bg-gradient-to-r from-sky-400 to-violet-800 bg-clip-text text-transparent font-bold";
  return(
    <div className="flex justify-center items-center h-screen bg-theme-1 mt-[-64px] flex-col">
